		...
		<section
			...
			<div className={"flex gap-10 flex-col"}>
				...
				<p className={"text-xl text-dimText text-justify px-4"}>
					به انبار هایی که در سطح شهر و یا خارج از شهر هستند و عموم مردم
					میتوانند از آن استفاده کنند انبار عمومی میگویند. در انبار های عمومی هر
					نوع کالا و اموالی را میتوان نگهداری کرد. از کالا های کارخانه گرفته تا
					لوازم منزل و شخصی و حتی خودرو. <br />
