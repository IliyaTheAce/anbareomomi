...
function Footer() {
  ...
  return (
    <section
      className={"bg-secondary w-full py-14 px-10 text-white flex flex-col"}
    >
      <div className="flex flex-wrap gap-5 w-full max-w-[1300px] mx-auto items-center justify-center">
        <div key="map-1" className={"flex flex-col gap-2 items-center"}>
          <Link
            href={
              "https://maps.google.com/maps?ll=35.675028,51.232624&z=16&t=m&hl=en&gl=US&mapclient=embed"
