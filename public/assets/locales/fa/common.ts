const Farsi = {
  ...
  hero: {
    ...
    content: `۲۵هزار متر مربع سوله , ۱۵۰۰ دستگاه کانتینر , ۱۵۰ هزار متر انبار روباز , ۲۰۰۰ متر سردخانه , ۱۰ دستگاه کامیونت و لیفتراک , ۵۰ نفر پرسنل مجرب آموزش دیده , ۳۰نفر نگهبان موسسه حفاظتی نیروی انتظامی`,
