...
const Articles = () => {
  const Pagination = dynamic(
    () => import("flowbite-react").then((pack) => pack.Pagination),
    {
  ...
  const FetchData = async () => {
    ...
    const response = await fetch(
      `https://panel.ejarecantiner.com/api/articles?populate=*&filters[isPublicArticle][$eq]=true&pagination[pageSize]=12&pagination[page]=${page}`,
      {
        method: "Get",
        headers: {
          Authorization:
